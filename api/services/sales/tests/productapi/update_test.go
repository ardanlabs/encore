...
func productUpdateOk(sd apitest.SeedData) []apitest.Table {
	table := []apitest.Table{
		{
			Name:  "basic",
...
func productUpdateBad(sd apitest.SeedData) []apitest.Table {
	table := []apitest.Table{
		{
			Name:    "input",
			Token:   sd.Users[0].Token,
...
func productUpdateAuth(sd apitest.SeedData) []apitest.Table {
	table := []apitest.Table{
		{
			Name:    "emptytoken",
			Token:   "&nbsp;",
