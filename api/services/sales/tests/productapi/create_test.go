...
func productCreateOk(sd apitest.SeedData) []apitest.Table {
	table := []apitest.Table{
		{
			Name:  "basic",
...
func productCreateBad(sd apitest.SeedData) []apitest.Table {
	table := []apitest.Table{
		{
			Name:    "missing",
			Token:   sd.Users[0].Token,
...
func productCreateAuth(sd apitest.SeedData) []apitest.Table {
	table := []apitest.Table{
		{
			Name:    "emptytoken",
			Token:   "&nbsp;",
