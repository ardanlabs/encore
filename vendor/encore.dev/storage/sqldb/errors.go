...
func ErrCode(err error) (_ sqlerr.Code) {
	...
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/sqldb/errors.go#L16-L22
...
func (*Error) Error() (_ string) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/sqldb/errors.go#L78-L80
	doPanic("encore apps must be run using the encore command")
	return
}
...
func (*Error) Unwrap() (_ error) {
	...
	//
	// The current implementation of this function can be found here:
	//    https://github.com/encoredev/encore/blob/v1.30.0/runtimes/go/storage/sqldb/errors.go#L82-L84
	doPanic("encore apps must be run using the encore command")
	return
}
