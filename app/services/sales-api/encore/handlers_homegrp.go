...
//encore:api auth method=POST path=/v1/homes tag:authorize_user_only
...
//lint:ignore U1000 "called by encore"
//encore:api auth method=PUT path=/v1/homes/:homeID tag:authorize_home
...
//lint:ignore U1000 "called by encore"
//encore:api auth method=DELETE path=/v1/homes/:homeID tag:authorize_home
func (s *Service) homeGrpDelete(ctx context.Context, homeID string) error {
	return s.hmeGrp.Delete(ctx, homeID)
}

//lint:ignore U1000 "called by encore"
//encore:api auth method=GET path=/v1/homes tag:authorize_any
...
//lint:ignore U1000 "called by encore"
//encore:api auth method=GET path=/v1/homes/:productID tag:authorize_home
