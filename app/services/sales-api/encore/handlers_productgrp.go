...
//encore:api auth method=POST path=/v1/products tag:authorize_admin_only
func (s *Service) productGrpCreate(ctx context.Context, anu productgrp.AppNewProduct) (productgrp.AppProduct, error) {
	return s.PrdGrp.Create(ctx, anu)
}

//lint:ignore U1000 "called by encore"
//encore:api auth method=PUT path=/v1/products/:productID tag:authorize_product
func (s *Service) productGrpUpdate(ctx context.Context, productID string, auu productgrp.AppUpdateProduct) (productgrp.AppProduct, error) {
	return s.PrdGrp.Update(ctx, productID, auu)
}
...
//lint:ignore U1000 "called by encore"
//encore:api auth method=GET path=/v1/products tag:authorize_admin_only
